...
<a class="font-label-caps text-label-caps text-on-surface hover:text-mustard-gold transition-colors duration-300" href="#">Brand Story</a>
<a class="font-label-caps text-label-caps text-on-surface hover:text-mustard-gold transition-colors duration-300" href="#">Collections</a>
...
<input class="input-kekeli w-full pb-2 font-body-md text-charcoal-luxe placeholder-outline-variant" placeholder="+33 6 12 34 56 78" type="tel"/>
</div>
</div>
...
<div>
<label class="block font-label-caps text-label-caps text-on-surface-variant mb-2">Taille</label>
<input class="input-kekeli w-full pb-2 font-body-md text-charcoal-luxe" placeholder="0" type="number"/>
</div>
<div>
...
<p class="font-body-md text-body-md text-ivory-light/60">
                    © 2024 KEKELI WEAR. ELEGANCE IN EVERY THREAD.
                </p>
</div>
